...
**
** Created: Sun Feb 3 11:27:37 2013
...
static const char qt_meta_stringdata_Thread[] = {
    "Thread\0\0,\0showdat(char,int)\0"
};
...
void Thread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->showdat((*reinterpret_cast< char(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    }
}
...
// SIGNAL 0
void Thread::showdat(char _t1, int _t2)
{
...
static const char qt_meta_stringdata_LED[] = {
    "LED\0\0str,num\0showdata(char,int)\0"
};
...
void LED::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->showdata((*reinterpret_cast< char(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    }
}
...
const QMetaObject LED::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_LED,
